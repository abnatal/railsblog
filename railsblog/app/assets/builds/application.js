          ...
          (function() {
            ...
            n2 = e2.strftime, r2 = e2.translate, t3 = e2.getI18nValue, e2.RelativeTime = function() {
              ...
              return a2.prototype.toString = function() {
                ...
                var t4, e3, n3, a3, i2;
                return n3 = new Date().getTime() - this.date.getTime(), a3 = Math.round(n3 / 1e3), e3 = Math.round(a3 / 60), t4 = Math.round(e3 / 60), n3 < 0 ? null : a3 < 10 ? (i2 = r2("time.second"), r2("time.singular", { time: i2 })) : a3 < 45 ? a3 + " " + r2("time.seconds") : a3 < 90 ? (i2 = r2("time.minute"), r2("time.singular", { time: i2 })) : e3 < 45 ? e3 + " " + r2("time.minutes") : e3 < 90 ? (i2 = r2("time.hour"), r2("time.singularAn", { time: i2 })) : t4 < 24 ? t4 + " " + r2("time.hours") : "";
...
%o`, message, error2, detail);
  ...
  var q = class {
    static proxyMethod(t2) {
      const { name: e2, toMethod: i2, toProperty: n2, optional: r2 } = U(t2);
  ...
  var Re = class extends tt {
    ...
    splitObjectsAtRange(t2) {
      let e2, [i2, n2, r2] = this.splitObjectAtPosition(Ee(t2));
  ...
  var je = class extends tt {
    ...
    insertDocumentAtRange(t2, e2) {
      ...
      return Et(e2) && a2.isEmpty() && !a2.hasAttributes() ? s2 = new this.constructor(s2.blockList.removeObjectAtIndex(r2)) : a2.getBlockBreakPosition() === o2 && n2++, s2 = s2.removeTextAtRange(e2), new this.constructor(s2.blockList.insertSplittableListAtPosition(i2, n2));
    }
    ...
    expandRangeToLineBreaksAndSplitBlocks(t2) {
      ...
      return i2 = s2.positionFromLocation(r2), n2 = s2.positionFromLocation(o2), { document: s2, range: t2 = St([i2, n2]) };
    }
    ...
    rangeFromLocationRange(t2) {
      ...
      return Et(t2) || (e2 = this.positionFromLocation(t2[1])), St([i2, e2]);
    }
    isEqualTo(t2) {
  ...
  var qe = "style href src width height class".split(" ");
  var Ue = "javascript:".split(" ");
  ...
  var ze = class extends q {
    ...
    constructor(t2) {
      ...
      super(...arguments), this.allowedAttributes = e2 || qe, this.forbiddenProtocols = i2 || Ue, this.forbiddenElements = n2 || Ve, this.body = _e(t2);
    }
    sanitize() {
  ...
  var Ke = class extends q {
    ...
    findBlockElementAncestors(t2) {
      ...
      for (; t2 && t2 !== this.containerElement; ) {
        const i2 = y(t2);
        S().includes(i2) && e2.push(t2), t2 = t2.parentNode;
      }
      return e2;
    }
    isBlockElement(t2) {
    ...
    getMarginOfBlockElementAtIndex(t2) {
      ...
      if (e2 && e2.textContent && !S().includes(y(e2)) && !this.processedElements.includes(e2))
        return Xe(e2);
    }
  ...
  var ci = class extends q {
    ...
    getExpandedRangeInDirection(t2) {
      ...
      return "backward" === t2 ? e2 ? i2 -= e2 : i2 = this.translateUTF16PositionFromOffset(i2, -1) : e2 ? n2 += e2 : n2 = this.translateUTF16PositionFromOffset(n2, 1), St([i2, n2]);
    }
    ...
    findContainerAndOffsetFromLocation(t2) {
      ...
      if (n2) {
        if (I(n2))
          ...
          if (e2 = n2.parentNode, !L(n2.previousSibling) && !E(e2))
            for (; n2 === e2.lastChild && (n2 = e2, e2 = e2.parentNode, !E(e2)); )
              ;
  ...
  var Ci = class extends q {
    ...
    createDOMRangeFromLocationRange(t2) {
      const e2 = this.findContainerAndOffsetFromLocation(t2[0]), i2 = Et(t2) ? e2 : this.findContainerAndOffsetFromLocation(t2[1]) || e2;
      if (null != e2 && null != i2) {
    ...
    getTextChangesFromCharacterData() {
      ...
      if (i2.length) {
        const n2 = i2[0], r2 = i2[i2.length - 1], o2 = function(t3, e3) {
          let i3, n3;
          return t3 = K.box(t3), (e3 = K.box(e3)).length < t3.length ? [n3, i3] = qt(t3, e3) : [i3, n3] = qt(e3, t3), { added: i3, removed: n3 };
  ...
  var Mi = class extends q {
    constructor(t2) {
      super(...arguments), this.element = t2, this.mutationObserver = new Pi(this.element), this.mutationObserver.delegate = this;
    ...
    handlerFor(t2) {
      return (e2) => {
        e2.defaultPrevented || this.handleInput(() => {
          f(this.element) || (this.eventName = t2, this.constructor.events[t2].call(this, e2));
        });
      };
    }
    handleInput(t2) {
  ...
  var Vi = class extends Mi {
    ...
    getCompositionInput() {
      ...
      this.compositionInput = new Ki(this);
    }
    isComposing() {
  ...
  be(Vi, "events", { keydown(t2) {
    this.isComposing() || this.resetInputSummary(), this.inputSummary.didInput = true;
    const e2 = qi[t2.keyCode];
    if (e2) {
      var i2;
      let n3 = this.keys;
    ...
    if (n2) {
      ...
      if (t3) {
        var v2, A2, x2;
        const e3 = zi(t3);
        !t3.name && e3 && (t3.name = "pasted-file-".concat(++Ui, ".").concat(e3)), i2.type = "File", i2.file = t3, null === (v2 = this.delegate) || void 0 === v2 || v2.inputControllerWillAttachFiles(), null === (A2 = this.responder) || void 0 === A2 || A2.insertFile(i2.file), this.requestRender(), null === (x2 = this.delegate) || void 0 === x2 || x2.inputControllerDidPaste(i2);
      }
    }
    t2.preventDefault();
  }, compositionstart(t2) {
    ...
    var e2;
    return this.setInputSummary({ preferDocument: false }), null === (e2 = this.delegate) || void 0 === e2 ? void 0 : e2.inputControllerWillPerformTyping();
  } } }), Vi.proxyMethod("responder?.getSelectedRange"), Vi.proxyMethod("responder?.setSelectedRange"), Vi.proxyMethod("responder?.expandSelectionInDirection"), Vi.proxyMethod("responder?.selectionIsInCursorTarget"), Vi.proxyMethod("responder?.selectionIsExpanded");
  var zi = (t2) => {
    var e2, i2;
    return null === (e2 = t2.type) || void 0 === e2 || null === (i2 = e2.match(/\/(\w+)$/)) || void 0 === i2 ? void 0 : i2[1];
  };
  var _i = !(null === (ji = " ".codePointAt) || void 0 === ji || !ji.call(" ", 0));
  var Hi = function(t2) {
    if (t2.key && _i && t2.key.codePointAt(0) === t2.keyCode)
      return t2.key;
    {
      let e2;
      if (null === t2.which ? e2 = t2.keyCode : 0 !== t2.which && 0 !== t2.charCode && (e2 = t2.charCode), null != e2 && "escape" !== qi[e2])
  ...
  Ki.proxyMethod("inputController.setInputSummary"), Ki.proxyMethod("inputController.requestRender"), Ki.proxyMethod("inputController.requestReparse"), Ki.proxyMethod("responder?.selectionIsExpanded"), Ki.proxyMethod("responder?.insertPlaceholder"), Ki.proxyMethod("responder?.selectPlaceholder"), Ki.proxyMethod("responder?.forgetPlaceholder");
  ...
  be(Gi, "events", { keydown(t2) {
    ...
    return Yi(t2) ? (t2.preventDefault(), this.attachFiles(t2.clipboardData.files)) : Qi(t2) ? (t2.preventDefault(), i2 = { type: "text/plain", string: t2.clipboardData.getData("text/plain") }, null === (r2 = this.delegate) || void 0 === r2 || r2.inputControllerWillPaste(i2), null === (o2 = this.responder) || void 0 === o2 || o2.insertString(i2.string), this.render(), null === (s2 = this.delegate) || void 0 === s2 ? void 0 : s2.inputControllerDidPaste(i2)) : n2 ? (t2.preventDefault(), i2 = { type: "text/html", html: this.createLinkHTML(n2) }, null === (a2 = this.delegate) || void 0 === a2 || a2.inputControllerWillPaste(i2), null === (l2 = this.responder) || void 0 === l2 || l2.insertHTML(i2.html), this.render(), null === (c2 = this.delegate) || void 0 === c2 ? void 0 : c2.inputControllerDidPaste(i2)) : void 0;
    ...
    var e2, i2;
    null !== (e2 = this.responder) && void 0 !== e2 && e2.selectionContainsAttachments() && (t2.dataTransfer.setData("application/x-trix-dragging", true), this.dragging = { range: null === (i2 = this.responder) || void 0 === i2 ? void 0 : i2.getSelectedRange(), point: tn(t2) });
  }, dragenter(t2) {
    Xi(t2) && t2.preventDefault();
  }, dragover(t2) {
    if (this.dragging) {
      t2.preventDefault();
      const i2 = tn(t2);
  ...
  } }), be(Gi, "inputTypes", { deleteByComposition() {
  ...
  var tn = (t2) => ({ x: t2.clientX, y: t2.clientY });
  var en = (t2) => nn(t2) && ". " !== t2.data;
  var nn = (t2) => o.samsungAndroid && "insertText" === t2.inputType && !t2.sourceCapabilities;
  var rn = "".concat("[data-trix-attribute]", ", ").concat("[data-trix-action]");
  var on = "".concat("[data-trix-dialog]", "[data-trix-active]");
  var sn = "".concat("[data-trix-dialog]", " [data-trix-method]");
  var an = "".concat("[data-trix-dialog]", " [data-trix-input]");
  var ln = (t2, e2) => (e2 || (e2 = hn(t2)), t2.querySelector("[data-trix-input][name='".concat(e2, "']")));
  var cn = (t2) => t2.getAttribute("data-trix-action");
  var hn = (t2) => t2.getAttribute("data-trix-attribute") || t2.getAttribute("data-trix-dialog-attribute");
  var un = class extends q {
    constructor(t2) {
      super(t2), this.didClickActionButton = this.didClickActionButton.bind(this), this.didClickAttributeButton = this.didClickAttributeButton.bind(this), this.didClickDialogButton = this.didClickDialogButton.bind(this), this.didKeyDownDialogInput = this.didKeyDownDialogInput.bind(this), this.element = t2, this.attributes = {}, this.actions = {}, this.resetDialogInputs(), d("mousedown", { onElement: this.element, matchingSelector: "[data-trix-action]", withCallback: this.didClickActionButton }), d("mousedown", { onElement: this.element, matchingSelector: "[data-trix-attribute]", withCallback: this.didClickAttributeButton }), d("click", { onElement: this.element, matchingSelector: rn, preventDefault: true }), d("click", { onElement: this.element, matchingSelector: sn, withCallback: this.didClickDialogButton }), d("keydown", { onElement: this.element, matchingSelector: an, withCallback: this.didKeyDownDialogInput });
    }
    ...
    eachActionButton(t2) {
      return Array.from(this.element.querySelectorAll("[data-trix-action]")).map((e2) => t2(e2, cn(e2)));
    }
    updateAttributes(t2) {
    ...
    eachAttributeButton(t2) {
      return Array.from(this.element.querySelectorAll("[data-trix-attribute]")).map((e2) => t2(e2, hn(e2)));
    }
    ...
    hideDialog() {
      const t2 = this.element.querySelector(on);
      var e2;
      if (t2)
  ...
  } } }), dn.proxyMethod("getSelectionManager().setLocationRange"), dn.proxyMethod("getSelectionManager().getLocationRange");
  var gn = Object.freeze({ __proto__: null, AttachmentEditorController: wi, CompositionController: Ti, Controller: Fi, EditorController: dn, InputController: Mi, Level0InputController: Vi, Level2InputController: Gi, ToolbarController: un });
  var mn = Object.freeze({ __proto__: null, MutationObserver: Pi, SelectionChangeObserver: wt });
  var pn = Object.freeze({ __proto__: null, FileVerificationOperation: Oi, ImagePreloadOperation: Ae });
  ...
  var vn = function(t2) {
    if (!t2.hasAttribute("contenteditable"))
      ...
      }("focus", { onElement: t2, withCallback: () => An(t2) });
  };
  var An = function(t2) {
    return xn(t2), yn(t2);
  };
  ...
  var Cn = o.forcesObjectResizing ? { display: "inline", width: "auto" } : { display: "inline-block", width: "1px" };
  mt("trix-editor", "%t {\n    display: block;\n}\n\n%t:empty:not(:focus)::before {\n    content: attr(placeholder);\n    color: graytext;\n    cursor: text;\n    pointer-events: none;\n    white-space: pre-line;\n}\n\n%t a[contenteditable=false] {\n    cursor: text;\n}\n\n%t img {\n    max-width: 100%;\n    height: auto;\n}\n\n%t ".concat("[data-trix-attachment]", " figcaption textarea {\n    resize: none;\n}\n\n%t ").concat("[data-trix-attachment]", " figcaption textarea.trix-autoresize-clone {\n    position: absolute;\n    left: -9999px;\n    max-height: 0px;\n}\n\n%t ").concat("[data-trix-attachment]", " figcaption[data-trix-placeholder]:empty::before {\n    content: attr(data-trix-placeholder);\n    color: graytext;\n}\n\n%t [data-trix-cursor-target] {\n    display: ").concat(Cn.display, " !important;\n    width: ").concat(Cn.width, " !important;\n    padding: 0 !important;\n    margin: 0 !important;\n    border: none !important;\n}\n\n%t [data-trix-cursor-target=left] {\n    vertical-align: top !important;\n    margin-left: -1px !important;\n}\n\n%t [data-trix-cursor-target=right] {\n    vertical-align: bottom !important;\n    margin-right: -1px !important;\n}"));
  var Rn = class extends HTMLElement {
    get trixId() {
      return this.hasAttribute("trix-id") ? this.getAttribute("trix-id") : (this.setAttribute("trix-id", ++bn), this.trixId);
    }
    get labels() {
      const t2 = [];
    ...
    connectedCallback() {
      this.hasAttribute("data-trix-internal") || (vn(this), function(t2) {
      ...
      }(this), this.editorController || (g("trix-before-initialize", { onElement: this }), this.editorController = new dn({ editorElement: this, html: this.defaultValue = this.value }), requestAnimationFrame(() => g("trix-initialize", { onElement: this }))), this.editorController.registerSelectionManager(), this.registerResetListener(), this.registerClickListener(), function(t2) {
  ...
  var Sn = { VERSION: "2.0.1", config: W, core: oi, models: Ri, views: Si, controllers: gn, observers: mn, operations: pn, elements: Object.freeze({ __proto__: null, TrixEditorElement: Rn, TrixToolbarElement: fn }), filters: Object.freeze({ __proto__: null, Filter: di, attachmentGalleryFilter: gi }) };
  window.Trix = Sn, setTimeout(function() {
    customElements.get("trix-toolbar") || customElements.define("trix-toolbar", fn), customElements.get("trix-editor") || customElements.define("trix-editor", Rn);
  }, 0);
